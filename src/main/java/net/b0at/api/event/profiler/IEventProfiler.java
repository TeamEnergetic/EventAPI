...
public interface IEventProfiler<T> {
    ...
    /**
     * Invoked after a {@code listener} is searched for {@link EventHandler}'s for the first time.
     *
     ...
     *
     * <p>
     * Precisely, this is invoked when {@link EventManager#fireEvent(Object, EventTiming)} is invoked with an {@code event} and
