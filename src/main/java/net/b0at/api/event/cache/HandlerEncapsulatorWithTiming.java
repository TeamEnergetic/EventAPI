 ...
 *
 * <p>
 * This encapsulator also invokes the {@link Method} with an applicable {@link EventTiming} argument.
 * </p>
 *
...
public class HandlerEncapsulatorWithTiming<T> extends HandlerEncapsulator<T> {
    /**
     * The set of all encapsulators this {@link HandlerEncapsulator} belongs to with timing {@link EventTiming#POST}.
     */
     ...
     * @param timing the {@link EventTiming} to pass to the {@link #listener}'s {@link #method}
     */
    @Override
