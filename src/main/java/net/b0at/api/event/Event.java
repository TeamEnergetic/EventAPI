 ...
 * {@link EventTiming#POST} may or may not be fired if the {@link EventTiming#PRE} {@link Event} is {@link #cancelled}.
 * <br>
 * Typically, only {@link EventHandler}s with timing set to {@link EventTiming#PRE} can be {@link #cancelled},
 * and attempting to cancel an {@link EventHandler} with timing set to {@link EventTiming#POST}
